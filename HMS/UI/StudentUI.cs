...
namespace HMS.UI
{
    class StudentUI 
    {
        ...
        public static void ViewRoommates(Student s)
        {
            ...
            if (r == null)
            {
                Console.WriteLine($"Room is not Assignied to {s.getname()}");
            }
            else 
        ...
        public static void RequestRoomChange(Student s)
        {
            ...
            Console.WriteLine("\n  [1] Request Room Change");
            Console.WriteLine("  [2] Request to Vacate / Checkout");
            Console.WriteLine("  [3] Genral Complain");
            Console.WriteLine("  ------------------------------------------------------------------");
            ...
            if (choice == "1")
            {
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("\n  [ERROR] Room change is currently unavailable.");
                    Console.ResetColor();
                }
                else
                {
